...
function getOrderDetail(id) {
  return utils_request.request({
    url: `/order/consumer/orders/${id}`,
    method: "get"
  });
}
function cancelOrder(value) {
  return utils_request.request({
    url: `/order/consumer/orders/cancel`,
    method: "put",
    params: value
  });
}
function deleteOrder(id) {
  return utils_request.request({
    url: `/order/consumer/orders/hide/${id}`,
    method: "put"
  });
}
function payOrder(value, id) {
  return utils_request.request({
    url: `/order/consumer/orders/pay/${id}`,
    method: "put",
    params: value
  });
}
...
function getCommentList(params) {
  return utils_request.request({
    url: `/user/consumer/evaluation/pageByCurrentUser`,
    method: "get",
    params
  });
}
function deleteComment(id) {
  return utils_request.request({
    url: `/user/consumer/evaluation/${id}`,
    method: "delete"
  });
}
function getCommentListByObj(params) {
  return utils_request.request({
    url: `/user/consumer/evaluation/pageByTarget`,
    method: "get",
    params
  });
}
function likeComment(value) {
  return utils_request.request({
    url: `/user/consumer/evaluation/likeOrCancel`,
    method: "post",
    params: value
  });
}
function setReport(value) {
  return utils_request.request({
    url: `/user/consumer/evaluation/userReport`,
    method: "post",
    params: value
  });
}
function getOrderScroll(params) {
  return utils_request.request({
    url: `/order/consumer/orders/consumerQueryList`,
    method: "get",
    params
  });
}
function getOrderPayResult(id) {
  return utils_request.request({
    url: `/order/consumer/orders/pay/${id}/result`,
    method: "get"
  });
}
