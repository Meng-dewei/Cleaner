...
const selectCity = (city) => {
  ...
  // 输出最终存储在 Vuex 中的值
  console.log('Vuex中保存的城市信息：', {
    cityCode: store.state.user.cityCode,
    cityName: store.state.user.cityName
  });
