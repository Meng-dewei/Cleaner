...
public class OperationServingOrderCancelStrategy implements OrderCancelStrategy {
    ...
    public void cancel(OrderCancelDTO orderCancelDTO) {
        ...
        //3.订单状态变更
        orderStateMachine.changeStatus(orderCancelDTO.getId().toString(), OrderStatusChangeEventEnum.CLOSE_SERVING_ORDER, orderSnapshotDTO);

        //4.取消服务单
        ordersSeizeApi.servingCancelByUserAndOperation(orderCancelDTO.getId());
