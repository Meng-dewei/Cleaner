package com.cskaoyan.duolai.clean.orders.constants;
...
public class RedisConstants {
    ...
    public static final class RedisKey {
         ...
         */
        public static final String PROVIDER_SERVE_NUM = "PROVIDER:SERVE:NUM_%s";
         ...
         */
        public static final String SERVE_PROVIDER_TIME = "PROVIDER:SERVE_TIME:%s";

        public static final String SERVE_PROVIDER_ACCEPT_NUM = "PROVIDER:SERVE_ACCEPT_NUM:%s";
