package com.cskaoyan.duolai.clean.market.constants;
...
public class RedisConstants {
    ...
    public static final class RedisKey {
         ...
         */
        public static final String COUPON_RESOURCE_STOCK = "COUPON:RESOURCE:STOCK";
         ...
         */
        public static final String COUPON_SEIZE_LIST = "COUPON:SEIZE:LIST:%s";
